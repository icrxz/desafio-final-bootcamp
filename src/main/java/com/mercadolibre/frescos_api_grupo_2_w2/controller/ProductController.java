...
public class ProductController {
    ...
    @PostMapping
    public ResponseEntity<ProductResponse> createProduct(@RequestBody @Valid ProductForm productForm) {
    ...
    public ResponseEntity<List<ProductResponse>> getProductsByCategory(@RequestParam String productType) {
    ...
    @GetMapping("/due-date")
    public ResponseEntity<List<BatchResponse>> getDueDateByDays(@RequestParam long days) {
    ...
    public ResponseEntity<List<BatchResponse>> getDueDateByDaysAndProductType(@RequestParam Long days, @RequestParam ProductTypeEnum type) {
        List<Batch> batches = this.batchService.dueDateAndProductTypeBatch(days, type);
        return new ResponseEntity<>(BatchMapper.batchListToListResponse(batches), HttpStatus.OK);
    }
  
    @GetMapping("batch/list")
    public ResponseEntity<BatchCompleteResponse> findBatchByProduct(@RequestParam UUID productId) {
    ...
    public ResponseEntity<BatchCompleteResponse> findBatchByProductOrder(@RequestParam(value = "productId") UUID productId,
